...
ifeq ($(config),debug)
TARGETDIR = ../../../build/bin/Debug-linux-${cfg.architecture}/imgui
TARGET = $(TARGETDIR)/libimgui.a
OBJDIR = ../../../build/bin-int/Debug-linux-${cfg.architecture}/imgui
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -fPIC -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -fPIC -g -std=c++17
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 -m64

else ifeq ($(config),release)
TARGETDIR = ../../../build/bin/Release-linux-${cfg.architecture}/imgui
TARGET = $(TARGETDIR)/libimgui.a
OBJDIR = ../../../build/bin-int/Release-linux-${cfg.architecture}/imgui
